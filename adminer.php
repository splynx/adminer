&¬×š¸RëıRSì“\nËjÀBşiÍ÷¸!\\e—5¥9ßkØ;Ó+{¯‹ï<ŸBåûnÀ[aœ–N”˜ÅB5”‹BwÈĞª‡DEºåÓìŠPÙf[JS£Ç0Å†SÚquj4ı±²o”/–÷-Šùï. šÉÆ‚à&X0l 0l¤ºàTÌ~í/4åğ\"÷Îşæ®>ø\$ìQî‚¾Î^ĞRP¬ôÏ‚/Ï\0æğFBĞ\$ñÎ^ÏpU®\\Ø0FPH9.…„,À¬j\ndZ[Ì\rEÌ\r\"ğ5oÜ°4\$‰v™Ìî'¯@½p0ğ\"úõ¯’Q/6õ˜ú0=F)\n‡ÖYeªÈĞ¸2ëø ƒ¯ºY„ÓËì—ëöbşP^Ãê?Et'Nà,ºL¾\$M	ğQÌ`#‹o”—0óp±(åiëìÎXÌÌ°õã°ªpRÏ£ÄĞc'‹ÔG3B.ä:lQ2?Q6í1<˜\".óG­§Áè_1@ Î„zÀAC\$<ğ¬Aà¨'Â€ï\0Ê`-;PÜKnÒŞzò­A\r‹øKc:…ñFï¦C& -v¤%0Ë’0e<O.I±>æ§…¥	#ñÁQÆñÇ8&€†O`Ø`Öq*ıĞ¨ê\$\n¼~/45*ä*öÿb>£p ª\nŠ\rÎªäöBH…àÒ±x0NQmÄ­Õ\")\"‚	gØw’i Ô.ÌNìĞâlDëã®8¦8\\1\\<Ïë%¬H'.ê §µÊ®L8®é Dh@;ª¦0j¤'Bj/-Âê 'p”çò1ÂE@ìax1®pû‘ĞğË´ór¡+m†	†ç²³\$²0æp.øŞæ¨í Ş‚ò##’Ê¬ï°P£îZçNü+\0ãî	®”(¬ü.š¹Ôî ÎnN(ü†4×†–!P=àU£<Bà>Â·,˜/Ã«%Òª7Ã»%6Eé|*NuKÆº“B0eG,EÂ¡^)*I.ğlNâH*Bz^‘'…P"; break;
...
<?php
		if ($missing == "auth") {
			...
			echo script_src(preg_replace("~\\?.*~", "", ME) . "?file=jush.js&version=4.8.2-dev");
			if (support("sql")) {
				?>
<script<?php echo nonce(); ?>>
<?php
...
<link rel="stylesheet" type="text/css" href="<?php echo h(preg_replace("~\\?.*~", "", ME) . "?file=default.css&version=4.8.2-dev"); ?>">
<?php echo script_src(preg_replace("~\\?.*~", "", ME) . "?file=functions.js&version=4.8.2-dev");  if ($adminer->head()) { ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo h(preg_replace("~\\?.*~", "", ME) . "?file=favicon.ico&version=4.8.2-dev"); ?>">
<link rel="apple-touch-icon" href="<?php echo h(preg_replace("~\\?.*~", "", ME) . "?file=favicon.ico&version=4.8.2-dev"); ?>">
...
<td><?php echo "<input type='image' class='icon' name='add[" . (support("move_col") ? 0 : count($fields)) . "]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=plus.gif&version=4.8.2-dev") . "' alt='+' title='" . lang(102) . "'>" . script("row_count = " . count($fields) . ";"); ?>
</thead>
<tbody>
<?php
...
<td><label class="block"><input type="radio" name="auto_increment_col" value="<?php echo $i; ?>"<?php if ($field["auto_increment"]) { ?> checked<?php } ?> aria-labelledby="label-ai"></label><td<?php echo $default_class; ?>><?php
		...
		echo (support("move_col") ?
			"<input type='image' class='icon' name='add[$i]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=plus.gif&version=4.8.2-dev") . "' alt='+' title='" . lang(102) . "'> "
			. "<input type='image' class='icon' name='up[$i]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=up.gif&version=4.8.2-dev") . "' alt='â†‘' title='" . lang(103) . "'> "
			. "<input type='image' class='icon' name='down[$i]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=down.gif&version=4.8.2-dev") . "' alt='â†“' title='" . lang(104) . "'> "
		: "");
		echo ($orig == "" || support("drop_col") ? "<input type='image' class='icon' name='drop_col[$i]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=cross.gif&version=4.8.2-dev") . "' alt='x' title='" . lang(105) . "'>" : "");
	}
}
	...
	foreach ((array) $referenced[$name] as $target_name => $refs) {
		foreach ($refs as $left => $columns) {
			...
			foreach ($columns as $target) {
				echo "\n<div class='references' title='" . h($target_name) . "' id='refd$left-" . ($i++) . "' style='left: $left1" . "em; top: " . $table["fields"][$target]["pos"] . "em; height: 1.25em; background: url(" . h(preg_replace("~\\?.*~", "", ME) . "?file=arrow.gif) no-repeat right center;&version=4.8.2-dev") . "'><div style='height: .5em; border-bottom: 1px solid Gray; width: " . (-$left1) . "em;'></div></div>";
			}
		}
	}
...
<?php echo checkbox("defaults", 1, ($_POST ? $_POST["defaults"] : adminer_setting("defaults")), lang(167), "columnShow(this.checked, 5)", "jsonly"); 
$comments = ($_POST ? $_POST["comments"] : adminer_setting("comments"));
echo (support("comment")
	? checkbox("comments", 1, $comments, lang(39), "editingCommentsClick(this, true);", "jsonly")
		. ' ' . (preg_match('~\n~', $row["Comment"])
...
<th><noscript><?php echo "<input type='image' class='icon' name='add[0]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=plus.gif&version=4.8.2-dev") . "' alt='+' title='" . lang(102) . "'>"; ?></noscript>
</thead>
<?php
if ($primary) {
...
foreach ($row["indexes"] as $index) {
	if (!$_POST["drop_col"] || $j != key($_POST["drop_col"])) {
		...
		echo "<td><input type='image' class='icon' name='drop_col[$j]' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=cross.gif&version=4.8.2-dev") . "' alt='x' title='" . lang(105) . "'>" . script("qsl('input').onclick = partial(editingRemoveRow, 'indexes\$1[type]');");
	}
	$j++;
}
?>
...
if (DB != "") {
	...
	echo "<input type='image' class='icon' name='add' src='" . h(preg_replace("~\\?.*~", "", ME) . "?file=plus.gif&version=4.8.2-dev") . "' alt='+' title='" . lang(102) . "'>\n";
}
?>
<input type="hidden" name="token" value="<?php echo $token; ?>">
</form>
